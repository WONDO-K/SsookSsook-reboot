...
public interface FamilyRelationRepository extends JpaRepository<FamilyRelation, Integer> {
    ...
    Optional<FamilyRelation> findByParent_ParentIdAndChild_ChildId(Integer parentId, Integer childId);
    ...
    List<FamilyRelation> findByParentAndChildAndStatus(Parent parent, Child child, Progress progress);
}
